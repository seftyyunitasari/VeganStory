...
# Payment Info
payment_info1 = PaymentInfo.create(user_id: 1, card_holder: "Jake Morton", card_number: "4916379629222343", expiration_date: "1/2025", cvc: "122")
payment_info2 = PaymentInfo.create(user_id: 2, card_holder: "Randal Carpio", card_number: "4556355610854422", expiration_date: "2/2025", cvc: "435")
payment_info3 = PaymentInfo.create(user_id: 3, card_holder: "Vera Stone", card_number: "4929890151305871", expiration_date: "3/2025", cvc: "134")
payment_info4 = PaymentInfo.create(user_id: 4, card_holder: "Hamish Duke", card_number: "4532433307175812", expiration_date: "4/2025", cvc: "278")
payment_info5 = PaymentInfo.create(user_id: 5, card_holder: "Lilith Bathory", card_number: "4532040475075458", expiration_date: "5/2025", cvc: "908")
payment_info6 = PaymentInfo.create(user_id: 6, card_holder: "Gabrielle Dupress", card_number: "5562329326508100", expiration_date: "6/2025", cvc: "124")
payment_info7 = PaymentInfo.create(user_id: 7, card_holder: "Edward Conventry", card_number: "5146583286886832", expiration_date: "7/2025", cvc: "971")
payment_info8 = PaymentInfo.create(user_id: 8, card_holder: "Selena Durov", card_number: "5100212025283390", expiration_date: "8/2025", cvc: "159")
payment_info9 = PaymentInfo.create(user_id: 9, card_holder: "Elizabeth Kepler", card_number: "5237510023106364", expiration_date: "9/2025", cvc: "149")
payment_info10 = PaymentInfo.create(user_id: 10, card_holder: "Eric Clarke", card_number: "5178302798469412", expiration_date: "10/2025", cvc: "201")
